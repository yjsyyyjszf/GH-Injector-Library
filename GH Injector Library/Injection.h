...
#define INJ_MAX_FLAGS 0x01FF007F
...
#ifdef _WIN64
DWORD InjectDLL_WOW64(const wchar_t * szDllFile, HANDLE hTargetProc, INJECTION_MODE im, LAUNCH_METHOD Method, DWORD Flags, DWORD & LastWin32Error, HINSTANCE & hOut);
